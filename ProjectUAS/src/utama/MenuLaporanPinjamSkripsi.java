 ...
 */
public class MenuLaporanPinjamSkripsi extends javax.swing.JPanel {

    ArrayList<Peminjamanskripsi> dataPeminjamanskripsi;
    ...
    private void tampilkan() {
        ...
        Join<Peminjamanskripsi, Peminjamanskripsi> skripsiJoin = peminjamanRoot.join("idskripsi", JoinType.INNER); // Sesuaikan dengan nama atribut di entitas Peminjaman_1
    ...
    public MenuLaporanPinjamSkripsi() {
        initComponents();
        tampilkan();
        //ambildata();
    ...
    private void initComponents() {
        ...
        jButtonJumlahSkripsiDipinjam = new javax.swing.JButton();
        ...
        jLabel7.setText("CETAK LAPORAN > Pinjam Skripsi");
        ...
        jLabelDataBuku.setText("LAPORAN PEMINJAMAN SKRIPSI ISCO");
        ...
        jButtonJumlahSkripsiDipinjam.setBackground(new java.awt.Color(51, 102, 255));
        jButtonJumlahSkripsiDipinjam.setFont(new java.awt.Font("SansSerif", 1, 12)); // NOI18N
        jButtonJumlahSkripsiDipinjam.setForeground(new java.awt.Color(255, 255, 255));
        jButtonJumlahSkripsiDipinjam.setText("JUMLAH SKRIPSI DIPINJAM");
        jButtonJumlahSkripsiDipinjam.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButtonJumlahSkripsiDipinjamActionPerformed(evt);
            }
        });
                    ...
                    .addGroup(jPanelViewLayout.createSequentialGroup()
                        .addGroup(jPanelViewLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanelViewLayout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addComponent(jButtonJumlahSkripsiDipinjam)))
                        .addGap(247, 392, Short.MAX_VALUE)
                        .addGroup(jPanelViewLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        jPanelViewLayout.setVerticalGroup(
            ...
            .addGroup(jPanelViewLayout.createSequentialGroup()
                ...
                .addGroup(jPanelViewLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(jButtonJumlahSkripsiDipinjam, javax.swing.GroupLayout.PREFERRED_SIZE, 34, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
...
//
    ...
    private void jButtonCetakActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonCetakActionPerformed
        try {
            String reportPath = "src/utama/reportPeminjamanSkripsi.jrxml";
...
//            }
            ...
            Root<Peminjamanskripsi> PeminjamanskripsiRoot = cq.from(Peminjamanskripsi.class);
            cq.select(PeminjamanskripsiRoot);
            ...
            Logger.getLogger(MenuLaporanPinjamSkripsi.class.getName()).log(Level.SEVERE, null, ex);
        }
...
//        }
    ...
    private void jButtonJumlahSkripsiDipinjamActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonJumlahSkripsiDipinjamActionPerformed
        try {
            String selection = (String) jComboBoxSearch.getSelectedItem();
            String reportPath = "src/utama/reportJumlahPeminjamanSkripsi.jrxml";
            String searchTerm = jTextFieldSearch.getText().trim();
            ...
            CriteriaQuery<Object[]> cq = cb.createQuery(Object[].class);
            Root<Peminjamanskripsi > peminjamanskripsiRoot = cq.from(Peminjamanskripsi.class);
            Join<Peminjamanskripsi, Skripsi> bukuJoin = peminjamanskripsiRoot.join("idskripsi", JoinType.INNER);

            cq.multiselect(
                    bukuJoin.get("idskripsi"),
                    bukuJoin.get("judulskripsi"),
                    cb.count(peminjamanskripsiRoot.get("idpinjam")).alias("jumlah_peminjaman")
            );

            cq.groupBy(bukuJoin.get("idskripsi"), bukuJoin.get("judulskripsi"));
            cq.orderBy(cb.desc(cb.count(peminjamanskripsiRoot.get("idpinjam"))));
            ...
            for (Object[] result : results) {
                ...
                map.put("idskripsi", isbn);
                map.put("judulskripsi", judul);
    ...
    }//GEN-LAST:event_jButtonJumlahSkripsiDipinjamActionPerformed


    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JButton jButtonCetak;
    private javax.swing.JButton jButtonJumlahSkripsiDipinjam;
